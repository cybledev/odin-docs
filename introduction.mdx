...
<CardGroup cols={2} horizontal={true}>
  ...
  <Card title="Exposed Buckets" icon="fill-drip" iconType="solid" href="/api-reference/hosts">
    ...
    Azure, Digital Ocean, Akamai, Linode, Alibaba, IBM Cloud etc. Our AI/ML models, combined with an
  ...
  <Card title="Exposed Files" icon="files" iconType="solid" href="/api-reference/hosts">
    Discover and analyze over 180 billion exposed files sourced from cloud
